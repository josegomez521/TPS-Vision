...
def similaridad (angulo1, tx1, ty1, escala1, imagenCortada):
    ...
    M2 = cv2.getRotationMatrix2D(centro, angulo1, escala1)
...
while(1):
    ...
    if k == ord('e'):
        similaridad(angulo, tx, ty, escala, imagenOut)
        cv2.imwrite('Transformacion de Similaridad.png', imagenSalida)
